...
void main() {
  test('intelligentCast handles doubles', () {
    double result = intelligentCast<double>("3.145");
    expect(result, 3.145);
  });

  test('intelligentCast handles booleans', () {
  ...
  test('intelligentCast handles integers', () {
    int result = intelligentCast<int>("42");
    expect(result, 42);
  });

  test('intelligentCast handles nulls', () {
  ...
  test('intelligentCast handles Strings', () {
  ...
  test('intelligentCast handles Colors', () {
